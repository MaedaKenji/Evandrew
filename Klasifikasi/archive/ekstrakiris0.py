...
# host = "192.168.142.159"  # IP address from MSI
# host = "192.168.100.59" # 343
port = 80


# address = "XX:XX:XX:XX:XX:XX"  # Replace with your ESP32's Bluetooth MAC address
# characteristic_uuid = "0000xxxx-0000-1000-8000-00805f9b34fb"  # Replace with the correct characteristic UUID

# async def send_data(data): #BT
...
model.load_weights(r'C:\Local Disk E\Code\Python\Evandrew\5024201076_Evandrew Reynald Collin_Program\trainingCNN\model_5_t.h5')
...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        for face_landmarks in results.multi_face_landmarks:
            ...
            cv2.polylines(image, [mesh_points[LEFT_IRIS]], True, (255,255,255), 1, cv2.LINE_AA)
            cv2.polylines(image, [mesh_points[RIGHT_IRIS]], True, (255,255,255), 1, cv2.LINE_AA)
            ...
            # After obtaining the cropped combined eye image...
            combined_eye_image2 = image[combined_y_min:combined_y_max, combined_x_min:combined_x_max]
